...
wget https://raw.githubusercontent.com/demon11d/VerusCliMining/main/config.json -O ~/ccminer/config.json
wget https://raw.githubusercontent.com/demon11d/VerusCliMining/main/config_luckpool.json -O ~/ccminer/config_luckpool.json
